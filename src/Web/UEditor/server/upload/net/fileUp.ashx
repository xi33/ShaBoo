...
public class fileUp : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        //向浏览器返回数据json数据
        //context.Response.Write("{'state':'" + state + "','url':'" + title + "','fileType':'" + currentType + "'}");originalFileName
        context.Response.Write("{'state':'" + state + "','url':'" + pathbase.Replace("../","") + filename + "','fileType':'" + currentType + "','originalFileName':'" + title + "'}");
    }
