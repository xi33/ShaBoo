...
(function () {
    ...
    UEDITOR_CONFIG = {
	    ...
	    catcherUrl: URL + "server/submit/net/getRemoteImage.ashx",
	    ...
	    imageManagerPath: URL + "server/submit/net/imageManager.ashx",
        ...
        snapscreenServerFile: URL + "server/upload/net/snapImgUp.ashx",
