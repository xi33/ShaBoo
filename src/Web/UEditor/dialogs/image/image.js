...
//                                            };
                                            ...
                                            img.setAttribute( i < 35 ? "src" : "lazy_src", editor.options.UEDITOR_HOME_URL + ci );
                                            img.setAttribute( "data_ue_src", editor.options.UEDITOR_HOME_URL + ci );
                                            //img.setAttribute(i < 35 ? "src" : "lazy_src", "http://" + location.host + editor.options.UEDITOR_HOME_URL.replace("..", "") + ci);
                                            //img.setAttribute("data_ue_src", "http://" + location.host + editor.options.UEDITOR_HOME_URL.replace("..", "") + ci);
