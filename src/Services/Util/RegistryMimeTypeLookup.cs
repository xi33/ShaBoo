...
namespace ShaBoo.Services.Util
{
    using System.IO;

    using Microsoft.Win32;

    public static class RegistryMimeTypeLookup
    {
    ...
    {"zip", "application/zip"}
        ...
        public static string GetMimeType(string fileNameOrPathWithExtension)
        {
        ...
        private static string LookupMimeTypeForExtension(string extension)
        {
            ...
            var dotExt = extension.Substring(1).ToLowerInvariant();
            ...
            var contentType = RegistryExtensionHelper.ToList().Where(_ => _.Key == dotExt).FirstOrDefault().Value;
            var xxx = contentType;
